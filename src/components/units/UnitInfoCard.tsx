  ...
  return (
    <Card className={cardClasses}>
      ...
      <CardContent className="p-0 flex flex-col items-center text-center">
        ...
        <div className="mt-0.5 sm:mt-1 font-semibold text-sm sm:text-base md:text-base text-foreground"> {/* Reducido mt-1 y md:text-lg */}
          {unitDetails.lastKnownLocation} - {displayLastKnownTime}
        </div>
        {unitDetails.meta && (
          <div className="text-xs sm:text-sm md:text-sm mt-0.5 sm:mt-1"> {/* Reducido mt-1, md:text-base */}
